...
\location{Native} English\\
\location{Beginner} Spanish
\sectionsep

\subsection{Technology}
\location{Basic} Adobe Photoshop, Adobe Illustrator
\location{Intermediate} 
\location{Advanced} Windows, MacOS, Linux, Google Suite, Microsoft Office
...
\workplace{SKIDATA AG }{Dec 2017 – July 2019}\\
